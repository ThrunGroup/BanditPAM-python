experiments = [
    ...
    # ['ucb', 0, 10, 100, 42, 'MNIST', ''],
    # ['ucb', 0, 10, 500, 42, 'MNIST', ''],
    # ['ucb', 0, 10, 1000, 42, 'MNIST', ''],
    #
    # ['ucb', 0, 10, 3000, 42, 'MNIST', ''],
    # ['ucb', 0, 10, 10000, 42, 'MNIST', ''],
    # ['ucb', 0, 10, 70000, 42, 'MNIST', ''],

    # ['naive_v0', 0, 5, 100, 42, 'MNIST', ''],
    # ['naive_v1', 0, 5, 100, 42, 'MNIST', ''],
    #
    # ['naive_v0', 0, 5, 300, 42, 'MNIST', ''],
    # ['naive_v1', 0, 5, 300, 42, 'MNIST', ''],

    # ['naive_v0', 0, 5, 1000, 42, 'MNIST', ''],
    # ['naive_v1', 0, 5, 1000, 42, 'MNIST', ''],

    # ['naive_v0', 0, 5, 3000, 42, 'MNIST', ''],
    # ['naive_v1', 0, 5, 3000, 42, 'MNIST', ''],

    # ['naive_v0', 0, 50, 100, 42, 'MNIST', ''],
    # ['naive_v1', 0, 50, 100, 42, 'MNIST', ''],

    # ['naive_v1', 0, 10, 100, 42, 'MNIST', ''],
    # ['naive_v1', 0, 10, 500, 42, 'MNIST', ''],
    #
    # ['naive_v0', 0, 10, 100, 42, 'MNIST', ''],
    # ['naive_v0', 0, 10, 500, 42, 'MNIST', ''],

    # ['ucb', 0, 50, 100, 42, 'MNIST', ''],
    # ['naive_v0', 0, 50, 100, 42, 'MNIST', ''],


    ['ucb', 0, 5, 100, 42, 'MNIST', ''],
    ['ucb', 0, 5, 300, 42, 'MNIST', ''],
    ['ucb', 0, 5, 1000, 42, 'MNIST', ''],
    ['ucb', 0, 5, 3000, 42, 'MNIST', ''],
]
