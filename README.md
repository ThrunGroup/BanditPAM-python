...
Test cases have been implemented in `tests.py`. To run them, run:
`py.test tests.py`
...
- `tests_exp_config.py` : a list of test experiments to run
- `tests.py` : called via `py.test tests.py` to actually run the experiments
